...
const LeftSidebar = () => {
  return (
    ...
    sticky left-0 top-0 h-screen flex flex-col justify-between overflow-y-auto 
    border-r p-6 pt-26 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-66.5"
    >
