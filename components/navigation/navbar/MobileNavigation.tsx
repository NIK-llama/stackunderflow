...
const MobileNavigation = async () => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        side="left"
        className="background-light900_dark200 border-none p-0 w-70 sm:w-[320px]"
      >
        ...
        <div className="no-scrollbar flex h-[calc(100vh-80px)] flex-col justify-between overflow-y-auto px-6 pb-6">
          <SheetClose asChild>
          ...
          <div className="primary-gradient font-space-grotesk font-bold tracking-wider text-white">
            {userId ? (
              <SheetClose asChild>
                <form
                  action={async () => {
